    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">@lang('labels.login')</div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label><input type="checkbox" name="remember"> @lang('labels.remember_me')</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/password/reset') }}">@lang('labels.forgot_your_password')</a>
                            </div>
                        </div>
                    </form>
                </div>
