    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading"><b>Welcome to Basic Starter Application</b></div>
                <div class="app-welcome"><img src="images/UNO-Mav.png"></div>
                <div class="panel-body">
                    <p>The original intent of this web application is to provide students in the MIS Capstone course with a basic starter web application.
                        Of course, this can also be used by students in other courses that can benefit from having a basic web application and not have to start from scratch.</p>
                    <p>
