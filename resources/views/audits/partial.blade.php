<div class="form-group{{ $errors->has('auditable_id') ? ' has-error' : '' }}">
    {!! Form::label('auditable_id', 'Object Id:', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group{{ $errors->has('auditable_type') ? ' has-error' : '' }}">
    {!! Form::label('auditable_type', 'Object Type:', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group{{ $errors->has('activity') ? ' has-error' : '' }}">
    {!! Form::label('activity', 'Activity:', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group{{ $errors->has('before') ? ' has-error' : '' }}">
    {!! Form::label('before', 'Before Values:', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group{{ $errors->has('after') ? ' has-error' : '' }}">
    {!! Form::label('after', 'After Values:', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
